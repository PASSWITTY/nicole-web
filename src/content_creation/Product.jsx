...
import image1 from '../resources/content_creation/one.png'
import image2 from '../resources/content_creation/two.png'
import image3 from '../resources/content_creation/three.png'
import image4 from '../resources/15.png'
import image5 from '../resources/17.png'
import image6 from '../resources/16.png'
...
const Product = () => {
  return (
    <div className='bg-[#f0ebe1]'>
        <h1 className="text-4xl pt-4 font-big font-bold text-center mb-10">Product Based Business</h1>
